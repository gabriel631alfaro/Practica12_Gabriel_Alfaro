...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLfloat currentFrame = glfwGetTime(); //frame actual 
		deltaTime = currentFrame - lastFrame;//frame acual menos el anterior 
		lastFrame = currentFrame;//se calcula el tiempo transcurrido 
...
void KeyCallback(GLFWwindow *window, int key, int scancode, int action, int mode)
{
	...
	if (keys[GLFW_KEY_SPACE])
	{
		...
		if (active)
		{
			Light1 = glm::vec3(1.0f, 1.0f, 0.0f); //cambia el color del escenario 
