...
// Fecha de entrega : 16 de marzo de 2025		317313521
...
int main( )
{
    ...
    GLFWwindow *window = glfwCreateWindow( WIDTH, HEIGHT, "Practica6_CMyCS_GABRIELA_SUAREZ", nullptr, nullptr );
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glClearColor(0.961f, 0.851f, 0.408f, 1.0f); //aqui se le cambia el color al fondo 
